<x-app-layout>
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 sm:p-8">
            <h1 class="text-xl font-bold text-gray-900 mb-1">Edit Pelanggan</h1>
            <p class="text-sm text-gray-500 font-mono mb-6">{{ $pelanggan->nomor_pelanggan }}</p>
            ...
            <form method="POST" action="{{ route('pelanggan.update', $pelanggan) }}">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" value="{{ old('nama', $pelanggan->nama) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        @error('nama')
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('alamat', $pelanggan->alamat) }}</textarea>
                    </div>

                    <div>
                        <label for="no_telepon" class="block text-sm font-medium text-gray-700 mb-1">No. Telepon</label>
                        <input type="text" id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $pelanggan->no_telepon) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="catatan" name="catatan" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">{{ old('catatan', $pelanggan->catatan) }}</textarea>
                    </div>
                </div>
